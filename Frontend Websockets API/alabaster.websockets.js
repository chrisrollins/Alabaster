/* 
This is a web browser websockets library for use with an Alabaster webserver.
*/
...
*/
const Alabaster = Object.freeze({
	WebSocketClient: function(route)
	{
		return Object.freeze((function()
		{
			...
			const socket = new WebSocket(`ws://${document.location.host}/${route || ""}`);
