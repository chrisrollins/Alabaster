...
namespace Alabaster
{
    ...
    public readonly struct Controller
    {
        ...
        public Controller(string method, RoutePatternMatch route, RouteCallback_B callback) :                       this(method, route, route.CreateCallback(callback)) { }
        public Controller(string method, RoutePatternMatch route, RouteCallback_C callback) :                       this(method, route, route.CreateCallback(callback)) { }
        ...
        public Controller(HTTPMethod method, RoutePatternMatch route, RouteCallback_B callback) :                   this(method.ToString(), route, route.CreateCallback(callback)) { }
        public Controller(HTTPMethod method, RoutePatternMatch route, RouteCallback_C callback) :                   this(method.ToString(), route, route.CreateCallback(callback)) { }
